/*
  ...
  - You are about to drop the column `project` on the `logging` table. All the data in the column will be lost.
  - Added the required column `task` to the `logging` table without a default value. This is not possible if the table is not empty.
