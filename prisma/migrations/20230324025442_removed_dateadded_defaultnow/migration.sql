...
INSERT INTO "new_logging" ("costPool", "date", "dateAdded", "description", "endTime", "id", "startTime", "task", "userId") SELECT "costPool", "date", "dateAdded", "description", "endTime", "id", "startTime", "task", "userId" FROM "logging";
DROP TABLE "logging";
